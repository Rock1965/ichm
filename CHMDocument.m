...
- (void)setupTOCSource{
    ...
    if (tocPath && [tocPath length] > 0 && ([oldTOC isEqual:[NSNull null]]  || oldTOC ==nil || oldTOC.pageList.count == 0 ))
    {
    ...
    CHMTableOfContent* oldIndexTOC = indexSource;
    if (indexPath && [indexPath length] > 0 && ([oldIndexTOC isEqual:[NSNull null]] || oldIndexTOC==nil || oldIndexTOC.pageList.count==0))
    {
